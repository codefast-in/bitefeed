                      ...
                      Wrap(
                        ...
                        children: [
                          ...auth.availablePreferences.map((pref) {
                            final isSelected = auth.selectedPreferences.contains(pref);
                          ...
                          if (!_isAddingCustom)
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(30),
                                  border: Border.all(color: AppColors.primaryOrange, style: BorderStyle.solid),
                                ),
                                child: const Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    Icon(Icons.add, color: AppColors.primaryOrange, size: 20),
                                    SizedBox(width: 4),
                                    Text(
                                      'Custom',
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    auth.addCustomPreference(_customController.text);
                      ...
                      SizedBox(
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushNamed(context, AppRoutes.findFriends);
                            },
                            style: ElevatedButton.styleFrom(
